...
| Isolated XDG + private D-Bus | `checks.gui-smoke` | Target validation, routing precedence, automatic/Preselection/fallback, mixed URL/file input, concurrent activations, FIFO queue, overflow, cancellation, launch errors, configuration pause, migration, recovery |
